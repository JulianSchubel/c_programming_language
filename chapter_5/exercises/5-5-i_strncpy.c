/* Write version of the library functions strncpy, strncat, and strncmp, which operate on at most n characters of their argument strings. Pad s with \0 if t_len < n */
